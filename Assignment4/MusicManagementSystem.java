...
class Song {
    ...
    public void removeLatestSong() {
        int latestSong = playlist.size();
        playlist.remove(latestSong - 1);
        System.out.println("\nPlaylist: ");
        for (String song : playlist) {
            System.out.println(song);
        }
...
public class MusicManagementSystem {
    public static void main(String[] args) {
        ...
        while (ans == 'Y' || ans == 'y') {
            ...
            System.out.println("6.Remove latest song");
            ...
            switch (ch) {
                ...
                case 6:
                    songList.get(1).removeLatestSong();
